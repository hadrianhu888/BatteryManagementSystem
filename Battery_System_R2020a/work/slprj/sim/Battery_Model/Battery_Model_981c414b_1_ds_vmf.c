...
_cg_const_1 [ 1448 ] = { false , false , true , true , false , false , true ,
...
true , true , true , true , true , true , true , true , true , true , true ,
true , true , true , true , true , true , true , true , true , true , true ,
true , true , true , true , true } ; PmBoolVector out ; int32_T b ; boolean_T
t0 [ 1448 ] ; ( void ) t1 ; ( void ) LC ; out = t2 -> mVMF ; for ( b = 0 ; b
< 1448 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 1448 ; b
