...
static emlrtRTEInfo c1_emlrtRTEI = { 128,/* lineNo */
  57,                                  /* colNo */
  "allOrAny",                          /* fName */
  "D:\\Program Files\\Matlab\\toolbox\\eml\\eml\\+coder\\+internal\\allOrAny.m"/* pName */
};
...
static void initSimStructsc1_Balancing_Logic(SFc1_Balancing_LogicInstanceStruct *
  chartInstance);
static void c1_sdiInitialize(SFc1_Balancing_LogicInstanceStruct *chartInstance);
static void c1_sdiTerminate(SFc1_Balancing_LogicInstanceStruct *chartInstance);
...
const mxArray *sf_c1_Balancing_Logic_get_eml_resolved_functions_info(void)
{
  ...
  const char_T *c1_data[4] = {
    "789c6360f4f465646060e0638080083608cd0be50b4069260654802ecf88838601560616147d30f97e289d9c9f57925a5102e1e425e6a6c275a6e4e766e625e6"
    ...
    "84073a400f0f747530fb0ac8b40f663e1f1a1fdd3e98bc936f707c704962496abc6b1e302406ccbf0fc8b40f667e1501fb60f2d17eb16e56317eaee1f1209f07"
    "04f97bc51b1918198245c03c5f7f17579f60383fc629b1a424b5a8d237312f313d353735af24b8b2b8243517261e0fe1c607014d31488c710626dfa2fc9c9cd4",
    "a218d490d5cb45f56f020efff013e95f5cf98b9781034caf6ab8ca484ffb18024e4fa3ab7d503050f655e0308fd8f42a86c33e013479cf3023bfdc3ce7e00203"
    "f3c4c06413c750cf0c9f5067843b0208d843c81d0c38f8b4361f00ce0b6a26", "" };

  c1_nameCaptureInfo = NULL;
  emlrtNameCaptureMxArrayR2016a(&c1_data[0], 1648U, &c1_nameCaptureInfo);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2357504432U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(494135076U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1003788359U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1752485533U);
}
...
{
  return "snGJT5vrsIpvP4DdQ1EZ97G";
}
...
const char* sf_c1_Balancing_Logic_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [30] = {
    "eNrtWs1vG0UU301SKykNVEUFIbWi4lA4VUkpKkUVJPFHcWUnbtdJq5LKmu6O7VFmZ9yZWSdGrdT",
    "/gBtHxIFDxYkjEv9ABRcuSEhIiCNH/gTe7K7tzdrrzzgEtSs5ydt97837va95s45h5osGXK/D58",
    "Vlw0jB70X4zBnBdSqkzcgnuL9gvB/Sf4AQ89wSEsiVxsCLIRffxZJTTxHO8qzK+7IRVsUCMxt4G",
    "1yoJG2SuB4lbC/nMVvrk/fqxK5bde5RZwNkkbPFaAu0NTxVAj0ZIrCtchg7qi64V6vnKKp1LBZq",
    "P13H9p703EEQJFaW19BmyaJHFWlQnD3Adp5JhcBi2bXNUkjhtDpIhKmRSqvNyN0GJYj1RVtH0sI",
    "NcLDC2w0Hfm55CkDF2ew6EmoD11ETywLZ83VyhuM6iYQHjwhDiguCaNalaS3Ya1uJgj1F7mA6wC",
    "Fg24bAaK/BCVPJ8bdygDTL0COKM/iRV0vWZuHHng7+DsH7WCT6rZrmTSxQDW+xxEV9h2QP/Gh1s",
    "qSXTREX7yCxbkP8JHYSsxcyR1oI4oTLIJHEhn2QeVkWpAnuTdTmuXmdmcNKxnODYMthbL62bBMP",
    "ikJHW85maUSpTGQr80YBNzH1tWaQQoPZAq39+aQkTpmDg3V6J1eDxwgEPmRLc+aQvuFqxhj8vrM",
    "JjeUwp+1Jxd00JG+mUOh93MuWZwqLKrJxvy4gEJEYfOa7N1mbQ6SOPTCCVco3rx9zkCHDuAxZ9V",
    "hmn4s98MmAJtKFoCOayIidGlSewn4RZCF0O4h6vYu6sgYhh4LZllBbidqATYd8GJ+N7Dp2dB8iF",
    "BehuoC3j+uk7oDrYFmTqFYGS1uQRp/ge1Cc0K208eVWA2+zPcb3WU5w1wq3giAKGENSIsEIq21A",
    "mxOtHKzes6zAj8t+pQ7oz+1L748rRnd/PDPC/ngqlPt7frx9dTmkv9L+45CVB6q7e3ZTjbsAjSn",
    "tCIACe2oz7FxVEvQnK0psasrNRR51CP1I/+3nvQV5L+oRX9Eo0eOHhRie9tXGczYitzZAzgx5on",
    "Ka3ihaFX97rOigT7f+D0PW/zImp+kvNh/mPtndzN6raEtKd7duV66uXF317/hUcSuTLVgdencDK",
    "WgjrSJikOkuNAurJRV22/crAVm5C1pW0C40MSU4pVjsHkZ6xe3a/XHE7jeG5M9yeP/7Z7+Z08gb",
    "pV++nkremM7+qPznQ+L2Vixums7vXN10WdpqrFxHd+xr69v5emE7Hej7IKLP7KMvmj+T8E8qF83",
    "rpbnD/AsxP83BHROueF0tG4PlUqGPdi4+vPnOzRd/Pv+58FP6u1t42Ppmz/pmp2brp8frb+06v9",
    "Ae0DobbrNnnxsl/m/H4q9pyW7dLn/UFDLfaJauZZw7q9kHN67f8vX9uDTY3tMxe9v3L+lJUXdbr",
    "V/YeSfSkpEXjPnxfE8N8cfSoXz/57Op5FeerMXl+/krFfOXpjcQTbvO4fydHMfi2lTyZ5+ujbJf",
    "LMdwaDqDqUJpTOkOp8o4IXi+HQ3PazE8mq7Smg6NPhv29JfJ8VyaDk+4fmkIngsxPBf8c1sF6TE",
    "PV+zVCiCDIzMMaZUCrxH76PC9dyT4hvWd8zF85wN8fYGdCFx/tdYmncMAVwfU1uZR4bl8LHE6F8",
    "OjaZjB4OyiK8vTx74KWe3qWzTH28/mQ1rbhpXBpWGrUedlM1yja9+cgVTvvJwaIrcUmXWNX5+uB",
    "dvJk7X/dD8yVo4lvm/G4qtpByl0TxCYuVmZ78CZl4sj7J83jqV/XozhuhjUYRWOfZS2ZtlnbhxJ",
    "n5lkbo/gS+w3k86p48oZr+ROhJz5Eto5yvulhQnlzAnljGOWmxbfrM/5s+af9D3XScMR/z0onkZ",
    "PPE8urvuL482J74b0p52vRNJ1Qp0+r73DxwWMqv2ehus/nx9s78KAfFoeYm8qUrfPxpyHz0Xmbl",
    "sjzDsHZa6/4SiiRtTf5mztN0d873wmVkdngvch4fCRy026/tyI6/c79x8afiZc/xvz5YjfUsx/S",
    "4H//MrBU6w/N13+bHLVNcH318Lx1Ks2fBbxfj4k3qmXpF5nlW/zR5xvr/rF/7xfzHh++d0YL87t",
    "71mu6Pkl/BeoBx+uw2m9JUnwJXH7dkno/82JPDru89u/xEHkhQ==",
    ""
  };

  static char newstr [2153] = "";
  newstr[0] = '\0';
  for (i = 0; i < 30; i++) {
...
static void mdlSetWorkWidths_c1_Balancing_Logic(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1012735318U));
  ssSetChecksum1(S,(3737664537U));
  ssSetChecksum2(S,(3142372008U));
  ssSetChecksum3(S,(1699193923U));
}
